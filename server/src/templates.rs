  ...
  <head>
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      .credit{margin-top:2rem;padding-top:1rem;border-top:1px solid #333;text-align:center;font-size:12px;color:#666}
      .credit a{color:#666;text-decoration:underline;border:none;padding:0;background:transparent;font-size:12px}
      .credit a:hover{color:#fff;background:transparent}
      @media(prefers-color-scheme:light){body{background:#fff;color:#000}img{border-color:#ddd}a,button{background:#000;color:#fff}a:hover,button:hover{background:#fff;color:#000;border-color:#000}.credit{border-color:#ddd;color:#999}.credit a{color:#999}.credit a:hover{color:#000}}
    </style>
  </head>
  <body>
    ...
    <div class="credit">
      Generated by <a href="https://w9.se" target="_blank" rel="noopener noreferrer">W9 Tools</a>
    </div>
  </body>
 </html>"#, ext = "html")]
  ...
  <head>
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      .credit{margin-top:2rem;padding-top:1rem;border-top:1px solid #ddd;text-align:center;font-size:12px;color:#999}
      .credit a{color:#999;text-decoration:underline;border:none;padding:0;background:transparent;font-size:12px}
      .credit a:hover{color:#000;background:transparent}
      ...
      @media(prefers-color-scheme:dark){body{background:#1a1a1a;color:#fff}main{background:#2a2a2a;border-color:#444}.info{background:#1f1f1f;border-color:#fff}a,button{background:#fff;color:#000;border-color:#fff}a:hover,button:hover{background:#000;color:#fff;border-color:#fff}a.secondary{background:#2a2a2a;color:#fff;border-color:#666}a.secondary:hover{background:#fff;color:#000}.credit{border-color:#444;color:#666}.credit a{color:#666}.credit a:hover{color:#fff}}
    </style>
  </head>
  <body>
    <main>
  ...
  <head>
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      .credit{padding:0.5rem 1rem;background:#000;text-align:center;font-size:11px;color:#666;border-top:1px solid #333}
      .credit a{color:#666;text-decoration:underline;border:none;padding:0;background:transparent;font-size:11px}
      .credit a:hover{color:#fff;background:transparent}
  ...
  <head>
    ...
    <style>
      *{margin:0;padding:0;box-sizing:border-box}
      ...
      .credit{margin-top:1.5rem;padding-top:1rem;border-top:1px solid #333;text-align:center;font-size:12px;color:#666}
      .credit a{color:#666;text-decoration:underline;border:none;padding:0;background:transparent;font-size:12px}
      .credit a:hover{color:#fff;background:transparent}
